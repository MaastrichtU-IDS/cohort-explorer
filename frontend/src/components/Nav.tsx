              ...
              <>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <ul className="text-xs text-base-content/70 space-y-1">
                      <li>✓ No programming: point-and-click choices</li>
                      <li>✓ Cross-cohort mapping specified by you in the interface, with suggestions based on standard terminology and mapping files</li>
