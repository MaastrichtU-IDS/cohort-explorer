  ...
  if (cohortsData && cohortsData[selectedFile]) {
    filteredVars = Object.entries(cohortsData[selectedFile]['variables'])
      ...
      .filter(([variableName, variableData]: any) =>
        ...
        ((includeCategorical && variableData.categories.length > 0) || (includeNonCategorical && variableData.categories.length === 0))
      )
      ...
      <aside className="p-2">
        ...
        <div className="mb-4 space-y-1">
          ...
          <div className='space-y-1'>
            <h3 className="font-bold">Categorical Filters</h3>
