...
function AppWithRouter({Component, pageProps}: {Component: any, pageProps: any}) {
  ...
  // The AI pages and Concept Coverage need the vertical real estate — no research-question banner there.
  const isAiPage = router.pathname === '/ai' || router.pathname.startsWith('/ai/');
  const hideBanner = isAiPage || router.pathname === '/concept-coverage';
