...
function AppWithRouter({Component, pageProps}: {Component: any, pageProps: any}) {
  ...
  return (
    <CohortsProvider useSparql={useSparql}>
      <Nav />
      {/* Banner for submitting clinical research questions - HIDDEN */}
      <div className="w-full bg-blue-100 text-blue-900 py-3 px-4 text-center font-semibold text-base shadow-sm hidden" role="region" aria-label="Submit Clinical Research Question" style={{borderBottom: '1px solid #b6d4fe'}}>
        <a
