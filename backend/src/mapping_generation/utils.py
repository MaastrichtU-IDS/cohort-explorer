...
def save_to_csv(data, filename):
    ...
    def map_and_combine_fields(row):
        ...
        mapped_row = {
            ...
            'Variable OMOP ID': row.get('Variable Concept OMOP ID',''),
            'Variable Concept Code': row.get('Variable Concept Code',''),
            'Domain': row.get('Domain', ''),
            'Additional Context Concept Name': row.get('Additional Context Concept Label', ''),
            ...
            'Categorical Value Name': row.get('Categorical Values Concept Label', ''),
            'Categorical Value Concept Code': row.get('Categorical Values Concept Code', ''),
            'Categorical Value OMOP ID':row.get('Categorical Values Concept OMOP ID', ''),
