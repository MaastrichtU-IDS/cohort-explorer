...
def cohort_to_dict(cohort: Cohort) -> Dict[str, Any]:
    ...
    for var_id, variable in cohort.variables.items():
        cohort_dict["variables"][var_id] = {
            ...
            "visit_concept_code": getattr(variable, "visit_concept_code", None),
            "visit_omop_id": getattr(variable, "visit_omop_id", None),
...
def build_cohort_variables_from_csv(cohort_id: str, csv_path: str) -> bool:
    ...
    for i, row in df.iterrows():
        try:
            ...
            # Extract optional SOURCENAME and SOURCE LABEL columns for multi-source cohorts
            source_name_val = _opt("SOURCENAME")
            source_label_val = _opt("SOURCE LABEL")
            ...
            variable = CohortVariable(
                ...
                visit_concept_code=_opt("VISIT CONCEPT CODE"),
                visit_omop_id=_opt("VISIT OMOP ID"),
