...
# environment build.
COHORTPOOL_COMMIT = "bfdf8a66d879d46b643796c02f87e0856f735dc9"  # cohortpool main, 31 Aug 2026
...
def create_provision_dcr(
    ...
    for participant in all_participants:
        ...
        builder.add_participant(
            ...
            analyst_of=["c1_data_dict_check", "c2_save_to_json", "c3_eda_data_profiling", "longitudinal_analysis", "shuffle_data"],
        )
